...
function FeatureCard({ icon: Icon, title, description, color, delay = 0 }) {
  return (
    <div 
      className="group relative bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-blue-500/10 hover:border-blue-200 transition-all duration-500 hover:-translate-y-1"
...
function PricingCard({ name, price, period, description, features, popular, cta }) {
  return (
    <div className={`relative rounded-3xl p-8 ${popular ? 'bg-gradient-to-br from-blue-600 to-indigo-700 text-white shadow-2xl shadow-blue-500/30 scale-105' : 'bg-white border border-slate-200'}`}>
      {popular && (
      ...
      <div className="text-center mb-8">
        ...
        <div className="flex items-baseline justify-center gap-1">
          ...
          {period && <span className={popular ? 'text-blue-200' : 'text-slate-500'}>/{period}</span>}
        </div>
        <p className={`mt-2 ${popular ? 'text-blue-200' : 'text-slate-500'}`}>{description}</p>
      </div>
      <ul className="space-y-4 mb-8">
        {features.map((feature, i) => (
          <li key={i} className="flex items-center gap-3">
            ...
            <span className={popular ? 'text-blue-100' : 'text-slate-600'}>{feature}</span>
          </li>
        ))}
      </ul>
      <Link
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-blue-400/10 rounded-full blur-3xl" />
        <div className="absolute top-1/3 right-0 w-[500px] h-[500px] bg-indigo-400/10 rounded-full blur-3xl" />
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/80 backdrop-blur-lg shadow-sm' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <Link 
                to="/signup" 
                className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-2.5 rounded-xl hover:shadow-lg hover:shadow-blue-500/30 font-medium transition-all hover:-translate-y-0.5"
              >
                Start Free Trial
              </Link>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-slate-100 px-6 py-4 space-y-4">
            ...
            <Link to="/signup" className="block bg-blue-600 text-white text-center py-3 rounded-xl font-medium">
              Start Free Trial
            </Link>
          </div>
        )}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-full px-4 py-2 mb-8">
              ...
              <span className="text-sm font-medium text-blue-700">Built by coaches, for coaches</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Link 
                to="/signup" 
                className="group flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-lg px-8 py-4 rounded-2xl hover:shadow-xl hover:shadow-blue-500/30 font-semibold transition-all hover:-translate-y-1"
              >
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-cyan-400 rounded-full blur-3xl" />
          <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-purple-500 rounded-full blur-3xl" />
        </div>
        <div className="max-w-4xl mx-auto px-6 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/signup" 
              className="group flex items-center justify-center gap-2 bg-white text-blue-600 text-lg px-8 py-4 rounded-2xl hover:shadow-xl font-semibold transition-all hover:-translate-y-1"
            >
              Start Your Free Trial
              <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </Link>
          ...
          <p className="text-blue-200 mt-6 text-sm">No credit card required • 14-day free trial • Cancel anytime</p>
        </div>
      </section>
      ...
      <footer className="bg-slate-900 text-slate-400 py-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xl font-bold text-white">StormTracker</span>
              </div>
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm">© {new Date().getFullYear()} StormTracker. All rights reserved.</p>
            <div className="flex items-center gap-2">
              <Shield size={16} />
